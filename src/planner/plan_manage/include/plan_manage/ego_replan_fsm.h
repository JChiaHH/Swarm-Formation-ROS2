...
namespace ego_planner
{
  ...
  private:
    ...
    rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr change_formation_sub_;
    void changeFormationCallback(const std_msgs::msg::Int32::SharedPtr msg);
    ...
    void RecvBroadcastPolyTrajCallback(const traj_utils::msg::PolyTraj::SharedPtr msg);
    void polyTraj2ROSMsg(traj_utils::msg::PolyTraj &msg);
    void formationWaypointCallback(const geometry_msgs::msg::PoseStamped::SharedPtr msg);
